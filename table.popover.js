 ...
 * @LastEditTime: 2019-06-27 14:25:29
...
+function($) {
    ...
    var NAME = 'tablePopover';
    var CLASSPREFIX = 'table-popover';
    var DATA_KEY = 'tablePopover'
    ...
    var TablePopover = function(args) {
        ...
        _proto.show = function(relatedTarget) {
            ...
            if ($('#' + this._element.id + '_' + IDNAME.TABLE)) {
                var table = $('#' + this._element.id + '_' + IDNAME.TABLE).DataTable({
                    lengthChange: false,
                    searching: false,
                    ordering: false,
                    info: false,
                ...
                table.on('click', 'tr', function() {
                    var rowSelectEvent = $.Event(Event.ROWSELECTED);
